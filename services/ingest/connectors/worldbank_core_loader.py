...
INDICATORS = [
    ...
    # Momentum / trade extras
    "NY.GDP.MKTP.KD.ZG", "BX.GSR.CCIS.CD",

    # Energy / environment
    "EG.USE.PCAP.KG.OE", "EN.ATM.PM25.MC.M3", "EG.ELC.ACCS.ZS", "EG.ELC.RNEW.ZS",
    ...
    # Health extras (fixed)
    "SH.IMM.MEAS",              # was SH.IMM.MEAS.ZS
    "SH.XPD.CHEX.PC.CD",

    # Safety (fixed)
    "VC.IHR.PSRC.P5",           # was SH.STA.HOMIC.ZS

    # Business / finance (substitutes)
    "IC.CRD.INFO.XQ",           # depth of credit information (0–8)
    "IC.CRD.PRVT.ZS",           # private credit bureau coverage (% adults)
    # Optional governance proxy
    "RL.EST",                   # Rule of Law (WGI, ~1996+)
