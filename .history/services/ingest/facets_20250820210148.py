...
def facet_fx(*, date: str, base_currency: str, rates: Dict[str, float]) -> Dict[str, Any]: return {"fx": {"date": date, "base_currency": base_currency, "rates": rates}}


# article/web facet


def facet_article(*, url: str, canonical: Optional[str], headings: List[str], author: Optional[str], published_at: Optional[str]) -> Dict[str, Any]:return {
"article": {
"url": url,
"canonical": canonical,
"headings": headings,
