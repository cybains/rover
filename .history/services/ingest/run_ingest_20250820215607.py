...
from .connectors.rest_countries import RestCountries
from .connectors.web_crawler_stub import SimpleCrawler
from .connectors.pdf_intake_stub import PdfIntake
from .connectors.worldbank import WorldBank   # <-- add this import
