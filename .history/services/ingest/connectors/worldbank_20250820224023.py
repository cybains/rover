...
# 👇 Try to import NormalizedDoc; fall back to a local shim if it doesn't exist.
try:
    from ..schemas import make_core, NormalizedDoc
except ImportError:
    from ..schemas import make_core  # still import make_core
    from dataclasses import dataclass

    @dataclass
    class NormalizedDoc:  # minimal shape used by the rest of your code
        core: Any
        facet: Any
        raw: Any
