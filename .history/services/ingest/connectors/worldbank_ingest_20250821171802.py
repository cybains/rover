...
def ingest_country(country_code: str):
    indicators = get_all_indicators()[:5]  # only 5 for testing
    print(f"Testing with {len(indicators)} indicators")
    ...
    for ind in indicators:
        try:
            ...
            if docs:
                ...
                print(f"Inserted {len(mongo_docs)} docs for {country_code} - {ind}")
